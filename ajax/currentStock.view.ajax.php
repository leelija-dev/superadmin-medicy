...
if (isset($_GET['currentStockId'])) {
    ...
    $showStock = json_decode($CurrentStock->showCurrentStockByPIdAndAdmin($productId));
    // print_r($showStock);
    ...
    <div class="container-fluid d-flex justify-content-center mt-2">
        <div class="container-fluid">
            ...
            foreach ($showStock as $stock) {
                ...
                $distributorDetails = json_decode($distributorDetails);
                // print_r($distributorDetails->data);
                if (isset($distributorDetails->data) && !empty($distributorDetails->data)) {
                    $distData = $distributorDetails->data;
                    if (isset($distData[0]->name)) {
