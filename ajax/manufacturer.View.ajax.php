...
<body class="mx-2">
    ...
    if (isset($showManufacturer->status) && $showManufacturer->status == 1) {
        if(isset($showManufacturer->data) && is_object($showManufacturer->data)){
            $manufacturerName = $showManufacturer->data->name;
            $shortName        = $showManufacturer->data->short_name;
            $manufacturerDsc  = $showManufacturer->data->dsc;
    }
    }
    ?>
