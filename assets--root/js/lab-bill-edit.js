...
document.addEventListener("DOMContentLoaded", function() {
  // Adding event listener to docList dropdown after the page is loaded
  let docList = document.getElementById("docList");
  if (docList.value) {
    document.getElementById("docName").setAttribute("disabled", true);
  }
  docList.addEventListener("change", function() {
    getDoc();
  });
});
...
##############################################################################*/
function getDoc() {
  let doctorId = document.getElementById("docList").value;
  request.open("GET", "ajax/billingDoc.ajax.php?doctor_id=" + doctorId, false);

  request.send(null);
  document.getElementById("preferedDoc").innerHTML = request.responseText;
  ...
  if (doc == "") {
    ...
    document.getElementById("prefferedDocId").value = doctorId;
    document.getElementById("docName").setAttribute("disabled", true);
...
function getPrice() {
  ...
  let price = parseFloat(request.responseText);
  ...
  request.send(null);
  document.getElementById("test-name").value = request.responseText;
...
function getBill() {
  ...
  var totalPValue = parseFloat(
    document.getElementById("total-test-price").value
  );
  // alert(totalPValue);
