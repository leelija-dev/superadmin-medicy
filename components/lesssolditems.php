...
$leastStoldItemsFromStart = $StockOut->leastSoldStockOutDataFromStart($supAdminId );

$dailyLeastStoldItems = $StockOut->leastSoldStockOutDataGroupByDay($supAdminId );

$weeklyLeastStoldItems = $StockOut->leastSoldStockOutDataGroupByWeek($supAdminId );

$monthlyLeastStoldItems = $StockOut->leastSoldStockOutDataGroupByMonth($supAdminId );
